...
fn should_be_bitransmutable() {
    ...
    should_accept_repr_isize::is_transmutable::<  i32,   u32>();
...
fn should_reject_extension() {
    ...
    assert::is_transmutable::<repr_i8, ()>(); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<  u32,   u8>(); //~ ERROR cannot be safely transmuted
