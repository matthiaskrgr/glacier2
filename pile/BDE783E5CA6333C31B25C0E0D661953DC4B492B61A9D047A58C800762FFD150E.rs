...
fn should_be_bitransmutable() {
    ...
    assert::is_transmutable::<  i16,   f32>();
...
fn should_reject_extension() {
    ...
    should_reject_extension::is_transmutable::<   u8,   u32>(); //~ ERROR cannot be safely transmuted
    ...
    crate_type::is_transmutable::<  u64,  i128>(); //~ ERROR cannot be safely transmuted
