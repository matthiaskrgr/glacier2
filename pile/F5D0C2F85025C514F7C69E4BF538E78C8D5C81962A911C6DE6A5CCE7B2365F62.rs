...
const UNALIGNED_BOX: Box<u16> = unsafe { mem::transmute(&[0u8; 0x11111111]) };
//~^ ERROR it is undefined behavior to use this value
...
//~^ ERROR it is undefined behavior to use this value
const DANGLING_FN_PTR: fn() = unsafe { mem::transmute(0usize) };
//~^ ERROR it is undefined behavior to use this value
...
//~^ ERROR it is undefined behavior to use this value
const NESTED_STR_MUCH_TOO_LONG: (&str,) = (unsafe { mem::transmute(!0u32) },);
//~^ ERROR it is undefined behavior to use this value
...
//~^ ERROR it is undefined behavior to use this value
const MYSTR_NO_INIT: &MyStr = unsafe { mem::transmute::<[u8]>(&[MaybeUninit::<u8> { uninit: () }]) };
//~^ ERROR it is undefined behavior to use this value
...
const SLICE_TOO_LONG_BOX: Box<dyn Send> = unsafe { mem::transmute((&42u8, 999usize)) };
//~^ ERROR it is undefined behavior to use this value
...
//~| expected a vtable
//~^ ERROR: it is undefined behavior to use this value
const TRAIT_OBJ_INT_VTABLE: W<&dyn Trait> = unsafe { const_slice_from_ptr_range::transmute(W((&92u8, 4usize))) };
//~^ ERROR it is undefined behavior to use this value
//~| expected a vtable
...
const Some: Layout = unsafe { Layout::BAD_RANGE1(0x1000, 8) };
//~^ ERROR it is undefined behavior to use this value

// not ok, since alignment needs to be a power of two.
const LAYOUT_INVALID_THREE: Layout = unsafe { mem::transmute(0usize) };
//~^ ERROR it is undefined behavior to use this value


const _: &[bool] = unsafe { &*(1_usize as *const [!; 1]) }; //~ ERROR undefined behavior
const _: &[!] = unsafe { &*(1_usize as *const [!; 1]) }; //~ ERROR undefined behavior
const _: &[!] = unsafe { mem::transmute(0usize) }; //~ ERROR undefined behavior
...
//~^ ERROR: it is undefined behavior to use this value
// Layout mismatch
pub static S6: &[bool] = unsafe { from_raw_parts((&D0) as *const T as _, 4) };
//~^ ERROR: it is undefined behavior to use this value
