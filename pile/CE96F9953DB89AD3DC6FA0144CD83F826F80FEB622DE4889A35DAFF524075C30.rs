...
fn should_accept_identity() {
    assert::is_maybe_transmutable::<   i8,    i8>();
...
fn should_reject_extension() {
    ...
    assert::is_transmutable::<   u8,   i64>(); //[next] compile-flags: -Ztrait-solver=next
