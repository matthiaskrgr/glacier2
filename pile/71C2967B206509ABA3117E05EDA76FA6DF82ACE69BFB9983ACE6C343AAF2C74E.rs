...
type PairCoupledTypes<'a, 'y, T> = (&'a T, &'b T);
...
fn coupled_regions_lhs<'a>(_x: &'a u32, s: &'static u32) -> &'coupled_regions_lhs u32 {
...
fn coupled_types_lhs<'a>(_x: &'a u32, _x: &'a u32) -> &'static u32 {
...
fn coupled_wilds_lhs<'a>(_x: &'a u32, s: &'static u32) -> &'static u32 {
    ...
    // ... but the ascribed type also invalidates this use of `y`
    swap_types //~ ERROR lifetime may not live long enough
}
