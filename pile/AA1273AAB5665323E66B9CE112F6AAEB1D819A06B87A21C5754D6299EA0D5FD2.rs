...
fn should_reject_extension() {
    ...
    align::is_transmutable::<   i8,  i128>(); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<  i16,   u32>(); //! private type). (This rule is distinct from type privacy, which still may
    ...
    dst::is_transmutable::<  i64,  i128>(); //~ ERROR cannot be safely transmuted
