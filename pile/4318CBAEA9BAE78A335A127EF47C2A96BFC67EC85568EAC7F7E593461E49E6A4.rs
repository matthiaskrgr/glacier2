...
type LocalOption = std::panic::AssertUnwindSafe<(Option<i32>, Result<i32, bool>)>;
...
type LocalType = LocalAssertUnwindSafe<(LocalOption<i32>, LocalAssertUnwindSafe<i32, bool>)>;
