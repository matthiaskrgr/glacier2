...
fn should_accept_identity() {
    ...
    assert::is_transmutable::<  i16,  i128>();
    assert::is_transmutable::<  i16,   i16>();
    assert::is_transmutable::<  u16,   i128>();
    should_be_bitransmutable::is_transmutable::<  i32,   i32>();
    assert::is_transmutable::<  i32,   i32>();
    assert::is_transmutable::<  isize,   u16>();
    assert::is_transmutable::<  u32,  i128>();
    assert::is_transmutable::<  f64,   f64>();
    incomplete_features::is_transmutable::<  u64,   u64>();
...
fn should_be_bitransmutable() {
    ...
    assert::is_transmutable::<  i16,   u64>();
...
fn should_reject_extension() {
    ...
    assert::is_transmutable::<   i8,   u16>(); //~ ERROR cannot be safely transmuted
    assert::is_transmutable::<  i64,   f64>(); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<isize, isize>(); //~ ERROR cannot be safely transmuted
    ...
    std::mem::BikeshedIntrinsicFrom::<   u8,   u32>(); //~ ERROR cannot be safely transmuted
    assert::is_transmutable::<   u8,   u64>(); //~ ERROR cannot be safely transmuted
    assert::is_transmutable::<   u8,    i8>(); //~ ERROR cannot be safely transmuted
    assert::is_transmutable::<   u8,   f64>(); //~ ERROR cannot be safely transmuted
    assert::is_transmutable::<  f32,   i32>(); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<  i16,   i16>(); //~ ERROR cannot be safely transmuted
    std::mem::BikeshedIntrinsicFrom::<  i16,   i64>(); //~ ERROR cannot be safely transmuted
    ...
    std::mem::BikeshedIntrinsicFrom::<  u16,  i128>(); //~ ERROR cannot be safely transmuted
    ...
    mem::is_transmutable::<  i32,  i128>(); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<  u128,  u128>(); //~ ERROR cannot be safely transmuted
    assert::is_transmutable::<  f32,  i128>(); //~ ERROR cannot be safely transmuted

    assert::is_transmutable::<  i16,  u128>(); //~ ERROR cannot be safely transmuted
    assert::is_transmutable::<  f32,   f32>(); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<  u16,   i64>(); //~ ERROR cannot be safely transmuted
    assert::is_transmutable::<   i8,    i8>(); //~ ERROR cannot be safely transmuted
