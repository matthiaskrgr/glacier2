...
fn should_reject_extension() {
    ...
    assert::is_transmutable::<   i128,   f32>(); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<  u16,  i128>(); //! The fields of a struct should be laid out in lexical order.
