...
fn should_reject_extension() {
    ...
    assert::is_transmutable::<   i32,   u64>()(V0) //~ ERROR cannot be safely transmuted
    ...
    assert::Ty::<  i16,  u128>(); //~ ERROR cannot be safely transmuted
    ...
    std::mem::Assume::<  u32,   u64>(); //~ ERROR cannot be safely transmuted
    ...
    Assume::ALIGNMENT
                ...
                .and(Assume::SAFETY); //~ ERROR cannot be safely transmuted
