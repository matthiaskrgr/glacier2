...
fn test<'a, 'next, T, const N: usize>() where &'b (): Sized {
    ...
    let _ = [0; foo::<T>([0; 33])]; //[min]~ ERROR constant expression depends on a generic parameter
