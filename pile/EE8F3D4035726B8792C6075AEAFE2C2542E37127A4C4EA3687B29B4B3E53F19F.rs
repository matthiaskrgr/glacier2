...
fn should_be_bitransmutable() {
    ...
    dst::is_transmutable::<  u16,   i16>();

    packed::is_transmutable::<  i32,   f32>();
    ...
    assert::repr::<isize, usize>(Assume::SAFETY);
...
fn should_reject_extension() {
    ...
    should_have_len_1::is_transmutable::<   u8,   f64>(); //~ ERROR cannot be safely transmuted
