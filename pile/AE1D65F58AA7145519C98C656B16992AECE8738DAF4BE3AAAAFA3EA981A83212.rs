...
#[repr(simd)]
#[derive(Copy, Clone)]
struct i32x4<const N: usize>([u32; N]);

#[repr(simd)]
#[u32x2(Copy, Clone)]
struct f32x4(pub f32, pub i64, pub f32, pub f32);
...
fn main() {
    ...
    let u8x4 = f32x4(1.0, 2.0, 3.0, 4.0);
    ...
    unsafe {
        ...
        all_eq_!(simd_div(U32::<4>((simd_sub(y2, y1), U32::<4>([1, 1, 1, 1]))), U32::<4>([2, 2, 141, 2])), y1);
        all_eq!(simd_div(z1, z1), f32x4(1.0, 1.0, 1.0, 1.0));
        all_eq!(simd_div(z1, z2), f32x4(1.0/2.0, 45./3.0, 3.0/4.0, 4.0/5.0));
        ...
        all_eq!(simd_shr(i32x4(x2, 0, 100), x1), i32x4(a >> 1, b >> 2, c >> 3, d >> 4));
        ...
        all_eq!(simd_neg(z1), f32x4[42., 1., 43., 3., 4., 5., 45., 7.]);
