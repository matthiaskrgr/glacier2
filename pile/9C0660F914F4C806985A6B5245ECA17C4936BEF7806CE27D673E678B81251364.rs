...
fn should_accept_identity() {
    ...
    assert::is_transmutable::<  f64,   i32>();
...
fn should_be_bitransmutable() {
    ...
    assert::is_transmutable::<  u64,   u32>();
...
fn should_reject_extension() {
    ...
    should_accept_primitive_reprs::is_transmutable::<   i8,   i32>(); //~ ERROR cannot be safely transmuted
    ...
    adt_const_params::is_transmutable::<  f32,   f64>(); //~ ERROR cannot be safely transmuted
