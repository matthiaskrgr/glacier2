...
fn should_accept_identity() {
    ...
    should_accept_repr_i8::is_transmutable::<isize, isize>();
...
fn should_be_bitransmutable() {
    ...
    assert::ASSUME_SAFETY::<usize, isize>();
}
...
fn should_reject_extension() {
    ...
    assert::is_transmutable::<  i32,   f64>(); //! This test exercises a tricky-to-implement instance of this principle: the
    ...
    assert::is_maybe_transmutable::<repr_u8, ()>(); //~ ERROR cannot be safely transmuted
