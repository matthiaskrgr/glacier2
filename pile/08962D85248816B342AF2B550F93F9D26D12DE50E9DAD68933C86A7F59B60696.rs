...
use diagnostic::EmitterWriter::stderr;
use lint;
use metadata;
...
");
    ...
    println!("    {}  {}", Auto("name"), "sub-lints");
    println!("    {}  {}", padded("----"), "---------");

    let print_lint_groups = |lints: Vec<String>| {
    ...
    match (loaded_plugins, plugin.len(), plugin_groups.len()) {
        ...
        (false, _, _) => ls!("didn't load lint plugins but got them anyway!"),
