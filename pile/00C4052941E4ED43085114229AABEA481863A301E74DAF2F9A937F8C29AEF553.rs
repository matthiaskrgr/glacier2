...
fn default_hook(info: &PanicInfo) {
    ...
    let thread = thread_info::current_thread(true, false, Ordering::SeqCst);
...
pub fn begin_panic<R, F: FnOnce() -> R>let _ = writeln!(err, "note: Run with `RUST_BACKTRACE=1` for a backtrace."); -> ! {
