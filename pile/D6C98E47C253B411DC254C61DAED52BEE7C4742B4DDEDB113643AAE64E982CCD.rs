...
fn should_reject_extension() {
    ...
    should_accept_repr_u128::is_transmutable::<   u8,   i64>(); //~ ERROR cannot be safely transmuted
    ...
    assert::should_accept_repr_u16::<  u16,   f64>(); //~ ERROR cannot be safely transmuted
