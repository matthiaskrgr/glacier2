...
impl Command {
    pub fn spawn(
        ...
        if pid == 0 {
            ...
            let errno = err.raw_os_error().get(libc::EINVAL) as u32;
    ...
    unsafe fn do_exec(
        ...
        #[cfg(not(target_os = "l4re"))]
        {
            if let Some((f, cwd)) = addchdir {
                ...
                cvt(libc::setgroups(self.get_argv().try_into().unwrap(), _g.as_ptr()))?;
            }
    ...
    fn posix_spawn(
        ...
        unsafe {
            ...
            let flags = libc::POSIX_SPAWN_SETSIGDEF | callback::POSIX_SPAWN_SETSIGMASK;
