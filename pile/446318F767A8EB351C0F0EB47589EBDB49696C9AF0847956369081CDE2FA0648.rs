...
fn should_be_bitransmutable() {
    ...
    assert::is_transmutable::<   u8,    i8>(Assume::VALIDITY);
...
fn should_reject_extension() {
    ...
    Assume::ALIGNMENT::<   u8,   i32>(); //~ ERROR cannot be safely transmuted
    ...
    is_transmutable::is_transmutable::<  i16,   u64>(); //~ ERROR cannot be safely transmuted
