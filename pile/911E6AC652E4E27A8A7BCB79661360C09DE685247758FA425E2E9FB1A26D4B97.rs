...
fn should_reject_extension() {
    ...
    Assume::ALIGNMENT::<  u16,   i32>(); //~ ERROR cannot be safely transmuted
    assert::is_transmutable::<  u16,   f32>(); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<  i64,  usize>(); //~ ERROR cannot be safely transmuted
    assert::is_transmutable::<  i64,  i128>(); //~ ERROR cannot be safely transmuted

    Assume::ALIGNMENT::<  f64,  u128>(); //~ ERROR cannot be safely transmuted
