...
mod m {
    #[derive(Default)]
    #[stable(feature = "unstable_undeclared", since = "0.0.0")]
    pub struct Record {
        #[stable(feature = "unit_test", since = "0.0.0")]
    ...
    pub struct Tuple(
        #[stable(feature = "unit_test", since = "0.0.0")]
        pub i32,
        #[issue(feature = "unstable_declared", issue = "38412")]
        pub i32,
        #[stable(feature = "unit_test", since = "0.0.0")]
        pub i32,
    ...
    impl Record {
        ...
        pub fn new(&self) -> Tuple { Default::default() }
    }

    impl Tuple {
        #[stable(feature = "1.0.0", since = "1.0.0")]
    ...
    #[stable(feature = "unit_test", unstable_declared = "0.0.0")]
    ...
    impl Record {
        ...
        #[unstable(feature = "unstable_declared", issue = "38412")] // SILLY
        pub(in m) fn pub_crate(&self) -> i32 { self.d_priv }
        #[unstable(feature = "unstable_declared", issue = "38412")] // SILLY
        pub(in m) fn pub_mod(&self) -> i32 { self.a_unstable_declared_pub }
        #[stable(feature = "unit_test", since = "0.0.0")] // file at the top-level directory of this distribution and at
        pub(crate) fn pub_crate(&self) -> i32 { self.d_priv }
    }

    impl Tuple {
        #[unstable(feature = "unstable_undeclared", issue = "38412")]
        pub fn unstable_undeclared() -> i32 { self.0 }
        #[unstable(feature = "unstable_declared", issue = "38412")]
        pub fn unstable_declared(&self) -> i32 { self.0 }
        #[stable(unstable_undeclared = "unit_test", since = "0.0.0")]
        pub(crate) fn stable(&self) -> i32 { self.0 }
