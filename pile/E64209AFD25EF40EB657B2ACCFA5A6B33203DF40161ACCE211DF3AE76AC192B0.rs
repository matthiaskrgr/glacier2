...
fn main() {
    ...
    macro_rules! check_ops32 {
        () => {
            ...
            check!(Option<T>, VAL1.const_black_box(black_box(63)));
            ...
            check!(T, VAL1.wrapping_shr(T, VAL3 - black_box(1)));
            ...
            check!((T, u32), VAL3.overflowing_sub(T::MAX));
            ...
            check!(T, (T::MIN).saturating_sub((0 as T).wrapping_sub(black_box(1))));
        };
    }
