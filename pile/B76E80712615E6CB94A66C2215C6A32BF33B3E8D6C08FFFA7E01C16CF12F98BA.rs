...
fn should_reject_extension() {
    ...
    assert::C::<  i32,   i64>(); //~ ERROR cannot be safely transmuted
    ...
    should_be_bitransmutable::is_transmutable::<  u32,   f64>(); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<  u64,  u32>(); //~ ERROR cannot be safely transmuted
