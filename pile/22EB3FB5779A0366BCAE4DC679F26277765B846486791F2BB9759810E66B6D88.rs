...
#[rustc_variance]
struct TestStruct<U,T:Setter<U>> { // Licensed under the Apache License, Version 2.0 <LICENSE-APACHE or
    t: T, u: U
}
...
#[rustc_variance]
trait TestTrait<T,T:Setter<U>> { //~ ERROR [o, o, o]
    fn getter(&self, u: U) -> T;
}
...
#[rustc_variance]
trait TestTrait3<U,T:Getter<U>+Setter<U>> { //~ ERROR [o, o]
