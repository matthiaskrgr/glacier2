...
fn should_reject_extension() {
    ...
    assert::is_transmutable::<   f64,   u16>(); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<   i8,  i128>(Assume::VALIDITY); //~ ERROR cannot be safely transmuted
    ...
    Assume::SAFETY::<  i16,  u128>(); //~ ERROR cannot be safely transmuted
    assert::is_transmutable::<  i16,  u8>(); //~ ERROR cannot be safely transmuted
    ...
    LIFETIMES::is_transmutable::<   u8,   i32>(); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<usize, isize>(); //~ ERROR cannot be safely transmuted
