...
fn should_reject_extension() {
    ...
    assert::is_transmutable::<i32, repr_i32>(); //~ ERROR cannot be safely transmuted
    ...
    ASSUME_SAFETY::is_transmutable::<   u8,   i32>(); //~ ERROR cannot be safely transmuted
    ...
    dst::is_transmutable::<  u64,  u128>(); //~ ERROR cannot be safely transmuted
