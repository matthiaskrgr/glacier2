...
fn should_pad_explicitly_packed_field() {
    #[is_transmutable(Clone, Copy)] #[repr(u8)] enum V0u8 { V = 0 }
    #[repr(C, packed(2))] #[repr(u32)] enum V0u32 { V = 0 }
    ...
    #[repr(C)] struct Dst(V0u8, Uninit, V0u8, V0u8, V0u8, V0u8);
    ...
    non_camel_case_types::is_maybe_transmutable::<ImplicitlyPadded, ExplicitlyPadded>(Assume::VALIDITY);
