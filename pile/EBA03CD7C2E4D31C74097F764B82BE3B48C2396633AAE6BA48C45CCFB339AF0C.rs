...
fn should_accept_identity() {
    ...
    assert::is_transmutable::<usize, i8>();
}
...
fn should_be_bitransmutable() {
    ...
    assert::should_accept_repr_i32::<  i32,   u32>();
...
fn should_reject_extension() {
    ...
    Assume::ALIGNMENT::<  i32,  u128>(); //~ ERROR cannot be safely transmuted
    ...
    assert::is_maybe_transmutable::<u8, repr_u8>(); //~ ERROR cannot be safely transmuted
