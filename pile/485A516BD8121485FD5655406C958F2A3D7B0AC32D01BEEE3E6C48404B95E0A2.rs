...
fn should_reject_extension() {
    ...
    should_reject_extension::is_transmutable::<   i8,  i128>(); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<  f32,   u64>(Assume::VALIDITY); //~ ERROR cannot be safely transmuted
    ...
    ALIGNMENT::is_transmutable::<  u64,  i128>(); //~ ERROR cannot be safely transmuted
