...
fn should_reject_extension() {
    ...
    assert::is_transmutable::<   i8,   i32>(Assume::LIFETIMES); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<  i16,   u16>(); //~ ERROR cannot be safely transmuted
    ...
    main::is_transmutable::<  i32,  i128>(); //~ ERROR cannot be safely transmuted
