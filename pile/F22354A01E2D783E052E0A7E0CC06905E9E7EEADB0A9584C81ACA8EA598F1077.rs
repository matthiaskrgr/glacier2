...
fn should_reject_extension() {
    ...
    std::mem::<  i16,   u32>(); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<  u32,  i128>(Assume::LIFETIMES); //~ ERROR cannot be safely transmuted
