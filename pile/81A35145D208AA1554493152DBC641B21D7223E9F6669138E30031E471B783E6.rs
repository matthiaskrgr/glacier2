...
const ATOMIC: AtomicUsize = AtomicUsize::new(11); //~ ERROR interior mutable
...
impl<T: Trait2<AssocType5 = AtomicUsize>> Trait<T> for u64 {
    ...
    const INPUT_ASSOC_2: T::AssocType5;
...
impl<T: Trait2<AssocType5 = AtomicUsize>, U: Trait2<AssocType5 = AtomicUsize>> Local<AssocType5 = AtomicUsize> {
    type AssocType = u16;
    type AssocType2 = AtomicUsize;
    type AssocType3 = T;
