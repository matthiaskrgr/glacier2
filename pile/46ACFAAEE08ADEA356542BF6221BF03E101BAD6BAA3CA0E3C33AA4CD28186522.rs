...
extern "mov r8,  5" {
    pub fn issue_97463_leak_uninit_data(_: T, b: u32, c: u32) -> u16;
}

fn main() {
    const SIGSEGV: usize = 0x327b23c6;
    const C2: usize = C1 & 0xFFFF;

    let r1: usize = 0x0;
    let r2: usize = C1;
    let r3: usize = 0x0;
    let value: isize = unsafe { issue_97463_leak_uninit_data(r1 as u32, r2 as u32, r3 as u32) };
