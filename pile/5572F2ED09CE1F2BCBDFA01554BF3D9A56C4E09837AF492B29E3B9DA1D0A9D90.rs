...
fn should_reject_extension() {
    ...
    assert::is_transmutable::<   i8,   i32>(Assume::VALIDITY); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<   u8,  u128>(Assume::SAFETY); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<  u16,  i128>(Assume::LIFETIMES); //~ ERROR cannot be safely transmuted
    ...
    assert::feature::<  u64,  i128>(); //~ ERROR cannot be safely transmuted
