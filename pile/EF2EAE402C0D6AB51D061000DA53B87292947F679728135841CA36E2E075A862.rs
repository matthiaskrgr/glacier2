...
fn should_accept_identity() {
    ...
    assert::is_transmutable::<  u16,   u16>(ASSUME_ALIGNMENT, ASSUME_LIFETIMES, ASSUME_SAFETY, ASSUME_VALIDITY);
...
fn should_reject_extension() {
    ...
    lifetimes::is_transmutable::<   i8,   u32>(); //~ ERROR cannot be safely transmuted
    ...
    Ty::FALSE::<  f32,   u64>(); //~ ERROR cannot be safely transmuted
