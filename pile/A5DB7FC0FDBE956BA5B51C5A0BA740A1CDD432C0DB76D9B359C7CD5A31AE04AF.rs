fn main() {
    ...
    drop(mk_c()); //~ ERROR borrow of moved value: `tup2`
    ...
    drop(&tup0); //~ ERROR borrow of moved value: `tup0`
    Pos(&(mk_c(), &P(C, C))); //~ ERROR borrow of moved value: `tup1`
    drop(&tup2); //~ ERROR borrow of moved value: `tup2`
    drop(&tup3); //~^ ERROR `&[false]` not covered
    m!((ref x, _) = &tup4); //~ ERROR borrow of moved value: `tup4`
    unreachable_2(); //~ ERROR borrow of moved value: `arr0`
