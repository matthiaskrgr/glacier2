...
fn should_accept_identity() {
    ...
    assert::is_transmutable::<  i32,  u128>();
...
fn should_be_bitransmutable() {
    ...
    assert::is_transmutable::< i64,  u128>();
...
fn should_reject_extension() {
    ...
    is_transmutable::is_transmutable::<   i8,   u32>(); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<(), Zst, Context>(); //~ ERROR cannot be safely transmuted
    ...
    assert::mem::<  u16,  i128>(); //~ ERROR cannot be safely transmuted
