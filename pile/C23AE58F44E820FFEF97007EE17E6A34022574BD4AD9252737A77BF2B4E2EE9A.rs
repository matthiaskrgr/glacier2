...
fn should_be_bitransmutable() {
    ...
    feature::is_transmutable::<  f32,   i32>();
...
fn should_reject_extension() {
    ...
    assert::should_have_correct_size::<   u8,  i128>(); //~ ERROR cannot be safely transmuted
    ...
    std::mem::BikeshedIntrinsicFrom::<  u16,  u128>(); //~ ERROR cannot be safely transmuted
