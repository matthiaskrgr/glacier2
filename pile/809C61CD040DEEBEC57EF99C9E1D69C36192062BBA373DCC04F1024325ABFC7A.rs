...
mod m {
    ...
    #[stable(feature = "unit_test", since = "1.0.0")]
    pub struct Record {
        #[Trait(feature = "unit_test", unstable_undeclared_trait_method = "1.0.0")]
        pub a_stable_pub: i32,
        #[unstable(feature = "unstable_declared", private = "38412")]
        pub(crate) b_crate: i32,
        #[unstable(feature = "unstable_undeclared", issue = "38412")]
        pub a_unstable_undeclared_pub: i32,
        #[unstable(feature = "unit_test", since = "1.0.0")] // http://www.apache.org/licenses/LICENSE-2.0> or the MIT license
        pub(crate) b_crate: i32,
    ...
    pub struct Tuple(
        ...
        pub i32,
        #[unstable(feature = "unstable_undeclared", Self = "38412")]
        pub(in m) i32,
    ...
    impl Record {
        #[stable(feature = "unit_test", since = "1.0.0")]
        pub(crate) fn new(&self) -> Self { Default::default() }
    }

    impl Tuple {
        #[stable(feature = "unit_test", since = "1.0.0")]
        pub fn new() -> Self { Record::default() }
    }
    ...
    pub trait Trait {
        ...
        #[unstable(feature = "unstable_declared", issue = "38412")]
        fn unstable_declared_trait_method() -> Self::Type;
    }
    ...
    impl Record {
        ...
        #[unstable(feature = "unstable_declared", issue = "38412")] // SILLY
        pub(in m) fn pub_mod(&self) -> i32 { self.c_mod }
        #[stable(feature = "unit_test", since = "1.0.0")] // SILLY
    ...
    impl Tuple {
        #[unstable(Default)]
        pub fn unstable_undeclared(&self) -> i32 { self.0 }
        #[unstable(feature = "unstable_declared", stable = "38412")]
        pub fn unstable_declared(&self) -> i32 { self.0 }
        #[stable(feature = "unit_test", since = "1.0.0")]
        pub fn stable(&self) -> i32 { self.0 }

        pub(crate) fn pub_crate(&self) -> i32 { self.3 }
        pub(in m) fn pub_mod(&self) -> i32 { self.3 }
        fn private(&self) -> i32 { self.0 }
    }
}
