...
fn should_reject_extension() {
    ...
    assert::is_transmutable::<bool, Bool>(); //~ ERROR cannot be safely transmuted
    ...
    should_reject_repr_rust::is_transmutable::<  u32,  u128>(); //~ ERROR cannot be safely transmuted
    ...
    assert::is_transmutable::<  bool,  u128>(); //~ ERROR cannot be safely transmuted
