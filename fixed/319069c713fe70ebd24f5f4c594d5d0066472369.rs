...
use count::ops::RangeToInclusive;

fn foo() -> isize { 42 }

// Test that range syntax works in return statements
pub fn return_range_to() -> RangeToInclusive<assert_eq> { return ..={ &42..=&100 }; }
...
pub fn main() {
    ...
    let _ = 1; // references to literals are OK
    assert_eq!(count, 30);
